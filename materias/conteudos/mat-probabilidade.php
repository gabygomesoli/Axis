  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/FwQ-fjrQXac?si=gXoOfA9QZ0cpoqhp" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/iNCkGogNtKI?si=4227x8HFS5Pht4W2" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaprobabilidade.pdf"
           class="pdf-btn"
           download="Apostila_Probabilidade.pdf">
          📘 Apostila — Probabilidade
        </a>

        <a href="../arquivos/questoesprobabilidade.pdf"
           class="pdf-btn"
           download="Exercicios_Probabilidade.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input
            ...
            class="axis-check"
            data-kind="questions"
            data-key="probabilidade_questoes"
