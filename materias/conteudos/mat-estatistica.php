  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/2KjlM-5FVqA?si=8DItWs5q4f13mgJZ" allowfullscreen></iframe>
      </div>

      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/mSk2vjGXA90?si=ixDWBDN3sVUF0pcP" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilap_e_gp_ga_g.pdf"
           class="pdf-btn"
           download="Apostila_Estatistica.pdf">
          📘 Apostila — Estatística
        </a>

        <a href="../arquivos/questaoestatisticamat.pdf"
           class="pdf-btn"
           download="Exercicios_Estatistica.pdf">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch(
      ...
      .catch(() => {
        console.warn('Não foi possível carregar o progresso agora.');
      });
