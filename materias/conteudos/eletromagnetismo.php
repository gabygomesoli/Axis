...
<head>
  ...
  <title>Eletromagnetismo · AXIS</title>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/n_w-wWwPcjY?si=EEQQlRTlGfMPMFOo" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/dKEo3Ru1qls?si=N6-rGyxqpy-S6VBB" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="eletromagnetismo_aula1"
      ...
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="eletromagnetismo_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaeletrodinamica.pdf"
           class="pdf-btn"
           download="Apostila_Eletromagnetismo.pdf">
          📘 Apostila — Eletromagnetismo
        </a>

        <a href="../arquivos/questoeseletromagnetismo.pdf"
           class="pdf-btn"
           download="Exercicios_Eletromagnetismo.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="eletromagnetismo_questoes"
