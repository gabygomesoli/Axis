...
<head>
  ...
  <title>Filosofia Antiga · AXIS</title>
...
<body>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_antiga_aula1"
      ...
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_antiga_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilafilosofiaantiga.pdf"
           class="pdf-btn"
           download="Apostila_Filosofia_Antiga.pdf">
          📘 Apostila — Filosofia Antiga
        </a>

        <a href="../arquivos/apostilafilosofiaantiga.pdf"
           class="pdf-btn"
           download="Exercicios_Filosofia_Antiga.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="filosofia_antiga_questoes"
