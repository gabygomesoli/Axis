...
$categoria    = 'geografia';
$subcategoria = 'geografia fisica';

$paginaAtual = "Geografia Física";
...
<div class="conteudo-biologia">
  ...
  <div class="videos-container">
    <div class="video-card">
      <iframe src="https://www.youtube.com/embed/yFFSphpiBuE?si=vkLWOLK7o9KeCB07" allowfullscreen></iframe>
    </div>
    <div class="video-card">
      <iframe src="https://www.youtube.com/embed/bvaj64NFkag?si=CMKJysE1Mi-RTbvB" allowfullscreen></iframe>
    </div>
  </div>
  ...
  <div class="lesson-status-group">
    ...
    <label class="status-toggle">
      <input type="checkbox" class="axis-check" data-kind="lesson" data-key="geofisica_aula1">
      <span class="status-box"></span><span class="status-label">Aula 1 concluída</span>
    </label>

    <label class="status-toggle">
      <input type="checkbox" class="axis-check" data-kind="lesson" data-key="geofisica_aula2">
  ...
  <div class="pdf-section">
    ...
    <div class="pdf-links">
      <a class="pdf-btn" download="Apostila_Geografia_Fisica.pdf" 
        href="../arquivos/apostilageografiafisica.pdf">📘 Apostila — Geografia Física</a>

      <a class="pdf-btn" download="Exercicios_Geografia_Fisica.pdf"
        href="../arquivos/questoesgeografiafisica.pdf">📘 Exercícios — Geografia Física</a>
    </div>

    <div class="lesson-status-group2">
      <label class="status-toggle">
        <input type="checkbox" class="axis-check" data-kind="questions" data-key="geofisica_questoes">
