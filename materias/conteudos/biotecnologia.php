...
<head>
  ...
  <title>Biotecnologia · AXIS</title>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/RDmb9OXtS4w?si=KRm5f08ayBWAa5Dh" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/gEpO_ultTBo?si=bZr6TTNKfmeEl3rM" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/introducao-a-biotecnologia.pdf"
           class="pdf-btn"
           download="Apostila_Biotecnologia.pdf">
          📘 Apostila — Biotecnologia
        </a>

        <a href="../arquivos/questõesbiotecnologia.pdf"
           class="pdf-btn"
           download="Exercicios_Biotecnologia.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="biotecnologia_questoes"
