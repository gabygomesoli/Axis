  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/AMVmyhq3hpE?si=gs78xv_U4Lu2aNcZ" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/YeEJjoJ2RWM?si=N35ZCG5O7fJYJvlR" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input
          ...
          class="axis-check"
          data-kind="lesson"
          data-key="quimica_organica_aula1"
      ...
      <label class="status-toggle">
        <input
          ...
          class="axis-check"
          data-kind="lesson"
          data-key="quimica_organica_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaquimicaorganica.pdf"
           class="pdf-btn"
           download="Apostila_Quimica_Organica.pdf">
          📘 Apostila — Química Orgânica
        </a>

        <a href="../arquivos/questoesquimicaorganica.pdf"
           class="pdf-btn"
           download="Exercicios_Quimica_Organica.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input
            ...
            class="axis-check"
            data-kind="questions"
            data-key="quimica_organica_questoes"
