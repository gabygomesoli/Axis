  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/f3MmmFcfe8g?si=HoPhkTdxFcUSWmt2" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/ss_bqAT-454?si=-Q0Dt2jYH0Gdur56" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/calorimetriaapostila.pdf"
           class="pdf-btn"
           download="Apostila_Calorimetria.pdf">
          📘 Apostila — Calorimetria
        </a>

        <a href="../arquivos/calorimetriaquestoes.pdf"
           class="pdf-btn"
           download="Exercicios_Calorimetria.pdf">
          📘 Exercícios — Calorimetria
        </a>
      </div>
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="calorimetria_questoes"
