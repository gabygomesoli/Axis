  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/cKPcV8FR-qE?si=zvqLZRiifqbtzbFR" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/bdo11n5Du34?si=EpUfrgl7GSrhJrct" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaidademoderna.pdf"
           class="pdf-btn"
           download="Apostila_Idade_Moderna.pdf">
          📘 Apostila — Idade Moderna
        </a>

        <a href="../arquivos/questoesidademoderna.pdf"
           class="pdf-btn"
           download="Exercicios_Idade_Moderna.pdf">
          📘 Exercícios — Idade Moderna
        </a>
      </div>
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input
            ...
            class="axis-check"
            data-kind="questions"
            data-key="idade_moderna_questoes"
