...
$subcategoria = 'interpretação grafica';
...
$paginaAtual = "Interpretação de Gráficos";
?>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/M-UrLeWqfxo?si=QQYzC9QMkM1XjXSG" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/XzZGAwfKs_k?si=eBkjyf3Q_DvI-kkl" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input
          ...
          class="axis-check"
          data-kind="lesson"
          data-key="interpretacao_graficos_aula1"
      ...
      <label class="status-toggle">
        <input
          ...
          class="axis-check"
          data-kind="lesson"
          data-key="interpretacao_graficos_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilap_e_gp_ga_g.pdf"
           class="pdf-btn"
           download="Apostila_Interpretacao.pdf">
          📘 Apostila — Interpretação
        </a>

        <a href="../arquivos/questaointerpretacaografico.pdf"
           class="pdf-btn"
           download="Exercicios_Interpretacao.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input
            ...
            class="axis-check"
            data-kind="questions"
            data-key="interpretacao_graficos_questoes"
