  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/Sm0s9Q0QF_k?si=X2LNFNWoVDOeCyAg" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/dq9NU31PqwU?si=3uJgWK9GeFhoiZO-" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_moderna_aula1"
      ...
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_moderna_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilafilosofiamoderna.pdf"
           class="pdf-btn"
           download="Apostila_Filosofia_Moderna.pdf">
          📘 Apostila — Filosofia Moderna
        </a>

        <a href="../arquivos/questoesfilosofiamoderna.pdf"
           class="pdf-btn"
           download="Exercicios_Filosofia_Moderna.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="filosofia_moderna_questoes"
