...
$categoria    = 'filosofia';
$subcategoria = 'filosofia contemporanea';
...
$paginaAtual = "Filosofia Contemporânea";
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  ...
  <title>Filosofia Contemporânea · AXIS</title>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/4VzqshtvrcE" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/MqCZSGWydXA" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_contemporanea_aula1"
      ...
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_contemporanea_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/ebookfiloconte.pdf"
           class="pdf-btn"
           download="Apostila_Filosofia_Contemporanea.pdf">
          📘 Apostila — Filosofia Contemporânea
        </a>

        <a href="../arquivos/ebookfiloconte.pdf"
           class="pdf-btn"
           download="Exercicios_Filosofia_Contemporanea.pdf">
          📘 Exercícios — Filosofia Contemporânea
        </a>
      </div>
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="filosofia_contemporanea_questoes"
