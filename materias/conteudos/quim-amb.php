...
$categoria = 'quimica';
$subcategoria = 'quimica ambiental';
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/A8J07TaDiDA?si=zjIOUnkHCnKuu1Md" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/9QEnMuBInYQ?si=o-YVDsjSpIpEhOcd" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input
          ...
          class="axis-check"
          data-kind="lesson"
          data-key="quimica_ambiental_aula1"
      ...
      <label class="status-toggle">
        <input
          ...
          class="axis-check"
          data-kind="lesson"
          data-key="quimica_ambiental_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaquimicaambiental.pdf"
           class="pdf-btn"
           download="Apostila_Quimica_Ambiental.pdf">
          📘 Apostila — Química Ambiental
        </a>

        <a href="../arquivos/questoesquimicaambiental.pdf"
           class="pdf-btn"
           download="Exercicios_Quimica_Ambiental.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input
            ...
            class="axis-check"
            data-kind="questions"
            data-key="quimica_ambiental_questoes"
