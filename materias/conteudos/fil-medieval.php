...
$categoria    = 'filosofia';
$subcategoria = 'filosofia medieval';
...
$paginaAtual = "Filosofia Medieval";
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  ...
  <title>Filosofia Medieval · AXIS</title>
...
<body>
  ...
  <div class="conteudo-biologia">
    ...
    <p class="descricao">
      Professores selecionados pela equipe Axis, que disponibilizam conteúdo gratuito no YouTube.
    </p>

    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/rNQbsOsWKWs?si=_m01RbULHP3tBvoE" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/Mu3vmF51Hgg?si=TeLqdVnR4GAX88eF" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_medieval_aula1"
      ...
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="filosofia_medieval_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/filosofiamedieval.pdf"
           class="pdf-btn"
           download="Apostila_Filosofia_Medieval.pdf">
          📘 Apostila — Filosofia Medieval
        </a>

        <a href="../arquivos/questoes-filosofia.pdf"
           class="pdf-btn"
           download="Exercicios_Filosofia_Medieval.pdf">
          📘 Exercícios — Filosofia Medieval
        </a>
      </div>
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="filosofia_medieval_questoes"
