...
<head>
  ...
  <title>Brasil Colônia · AXIS</title>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/p6IxQbme1pI?si=r5uZrRNdWQo1K2gM" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/qtwz_HKqUUg?si=qnsf6PgVqGO9SJdF" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilabrasilcolonia.pdf"
           class="pdf-btn"
           download="Apostila_Brasil_Colonia.pdf">
          📘 Apostila — Brasil Colônia
        </a>

        <a href="../arquivos/questoesbrasilcolonia.pdf"
           class="pdf-btn"
           download="Exercicios_Brasil_Colonia.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="brasilcolonia_questoes"
