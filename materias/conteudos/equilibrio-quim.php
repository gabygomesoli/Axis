...
$categoria    = 'quimica';
$subcategoria = 'equilibrio quimico';
...
$paginaAtual = "Equilíbrio Químico";
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  ...
  <title>Equilíbrio Químico · AXIS</title>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/Wz2QLkV9Q98?si=kHZUL9LHVXjysv8V" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/joQbc8s6DKE?si=l59McjNfbbHUtGYO" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="lesson-status-group">
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="equilibrio_quimico_aula1"
      ...
      <label class="status-toggle">
        <input type="checkbox"
               class="axis-check"
               data-kind="lesson"
               data-key="equilibrio_quimico_aula2"
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaequilibrioquimico.pdf"
           class="pdf-btn"
           download="Apostila_Equilibrio_Quimico.pdf">
          📘 Apostila — Equilíbrio Químico
        </a>

        <a href="../arquivos/questoesequilibrioquimico.pdf"
           class="pdf-btn"
           download="Exercicios_Equilibrio_Quimico.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="equilibrio_quimico_questoes"
