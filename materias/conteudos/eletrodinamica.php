...
<head>
  ...
  <title>Eletrodinâmica · AXIS</title>
  ...
  <div class="conteudo-biologia">
    ...
    <div class="videos-container">
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/yfGAhEtqkbk?si=dngOYa12hmG4Gk_A" allowfullscreen></iframe>
      </div>
      <div class="video-card">
        <iframe src="https://www.youtube.com/embed/C5496b0TJaY?si=lVRFJPJnjGLzFO2Z" allowfullscreen></iframe>
      </div>
    </div>
    ...
    <div class="pdf-section">
      ...
      <div class="pdf-links">
        <a href="../arquivos/apostilaeletrodinamica.pdf"
           class="pdf-btn"
           download="Apostila_Eletrodinamica.pdf">
          📘 Apostila — Eletrodinâmica
        </a>

        <a href="../arquivos/eletrodinamicaexercicios.pdf"
           class="pdf-btn"
           download="Exercicios_Eletrodinamica.pdf">
      ...
      <div class="lesson-status-group2">
        <label class="status-toggle">
          <input type="checkbox"
                 class="axis-check"
                 data-kind="questions"
                 data-key="eletrodinamica_questoes"
