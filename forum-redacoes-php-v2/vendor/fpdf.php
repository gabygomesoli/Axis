<?php
/*
 * Minimal FPDF 1.86 (stripped) for demo purposes.
 * Para todos os recursos, baixe a versão oficial em http://www.fpdf.org
 */
...
class FPDF {
    ...
    // Propriedades de margem e quebra de página (adicionadas para evitar erro no PHP 8.2+)
    protected $lMargin = 0;
    protected $tMargin = 0;
    protected $rMargin = 0;
    ...
    function _escape($s) {
        // Corrigido: escapa \ (barra invertida), () e quebras de linha
        return str_replace(
            array('\\', '(', ')', "\r", "\n"),
            array('\\\\', '\(', '\)', '\r', '\n'),
            $s
